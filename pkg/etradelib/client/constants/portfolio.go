...
var portfolioSortByToString = map[PortfolioSortBy]string{
	...
	// I verified that the ETrade API misspells "INTRINSIC" as "INSTRINIC" in
	// the string below. The correct spelling returns a 400 Bad Request.
	PortfolioSortByIntrinsicValue:      "INSTRINIC_VALUE",
