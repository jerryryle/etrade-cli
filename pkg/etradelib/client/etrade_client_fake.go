...
func (c *ETradeClientFake) GetAccountBalances(accountIdKey string, realTimeNAV bool) (
	*responses.BalanceResponse, error,
) {
...
func (c *ETradeClientFake) ListTransactionDetails(
	accountIdKey string, transactionId string,
) (*responses.TransactionDetailsResponse, error) {
...
func (c *ETradeClientFake) GetOptionExpireDates(
	symbol string, expiryType ExpiryType,
