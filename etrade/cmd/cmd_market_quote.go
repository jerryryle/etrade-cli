...
var quoteListAllDescriptor = []RenderDescriptor{
	{
		...
		Values: []RenderValue{
			...
			{Header: "Dividend Date", Path: ".all.exDividendDate", Transformer: dateTransformer},
			...
			{Header: "Dividend Payable Date", Path: ".all.dividendPayableDate", Transformer: dateTransformer},
			{Header: "PE", Path: ".all.pe"},
			{Header: "52-Week Low Date", Path: ".all.week52LowDate", Transformer: dateTransformer},
			{Header: "52-Week High Date", Path: ".all.week52HiDate", Transformer: dateTransformer},
...
var quoteListMutualFundDescriptor = []RenderDescriptor{
	{
		...
		Values: []RenderValue{
			...
			{Header: "Time Of Last Trade", Path: ".mutualFund.timeOfLastTrade", Transformer: dateTimeTransformer},
			...
			{Header: "Order Cutoff Time", Path: ".mutualFund.orderCutoffTime"},
			...
			{Header: "Fund Inception Date", Path: ".mutualFund.fundInceptionDate", Transformer: dateTransformer},
			...
			{Header: "52-week High Date", Path: ".mutualFund.week52HiDate", Transformer: dateTransformer},
			{Header: "52-week Low Date", Path: ".mutualFund.week52LowDate", Transformer: dateTransformer},
